...
class ParserModel(Model):
    ...
    def add_embedding(self):
        ...
        with tf.variable_scope('embeddings'): 
            ...
            embeddings = tf.reshape(embed_seq, [-1, Config.n_features * Config.embed_size])
        ### END YOUR CODE
        return embeddings
    ...
    def add_prediction_op(self):
        ...
        with tf.name_scope('logits'): 
            W2 = tf.get_variable('weights_2', 
                                 shape=[Config.hidden_size, Config.n_classes],
                                 initializer=xavier_weight_init())
            b2 = tf.get_variable('biases_2',
    ...
    def add_loss_op(self, pred):
        ...
        ### YOUR CODE HERE
        loss = tf.reduce_mean(
            tf.nn.softmax_cross_entropy_with_logits(labels=self.labels_placeholder, logits=pred))
        ### END YOUR CODE
        return loss
